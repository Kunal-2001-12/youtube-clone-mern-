      ...
      <div className="allvideo-sectionn">
        ...
        <div
          ...
          style={{
            ...
            display: loading === true ? "none" : "grid",
            gap: '40px', // Large gap for clear separation
            padding: '0 40px 48px 40px', // Large side padding
            gridTemplateColumns: 'repeat(3, 1fr)', // Always 3 columns for desktop
              ...
              return (
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    style={{ borderRadius: '20px 20px 0 0', minHeight: '180px', maxHeight: '220px', width: '100%' }}
                  />
